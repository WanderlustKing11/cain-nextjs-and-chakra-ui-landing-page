    ...
    <div>
      <VStack>
        ...
        <Container my={2} mx={5} color={'gray.700'}>
          <Heading as='h2' fontSize={'2.2rem'} color={'gray.600'} my={2}>General rules</Heading>
        ...
        <Container my={2} mx={5} color={'gray.700'}>
          <Heading as='h2' fontSize={'2.2rem'} color={'gray.600'} my={4}>Changes about privacy</Heading>
